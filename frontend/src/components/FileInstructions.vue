              ...
              <v-container>
                <v-row>
                  <v-col cols="12" md="12" sm="6">
                    <v-text-field v-model="editedItem.name" label="Dataset Name"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="12" sm="6">
                    <v-text-field v-model="editedItem.calories" label="Destination"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="12" sm="6">
...
const headers = [
  ...
  { title: 'Format', key: 'fat' },
  { title: 'updated_at', key: 'carbs' },
