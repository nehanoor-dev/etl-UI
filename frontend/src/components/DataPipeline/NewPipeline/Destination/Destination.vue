<template>
  <v-container>
    ...
    <v-row justify="end">
      <v-btn @click="addDestination" elevation="1"
            ...
            <v-row class="align-center pa-2" justify="space-between">
              <v-col>
                <v-text-field v-model="search" label="Search" prepend-inner-icon="mdi-magnify" variant="outlined"
                  hide-details class="custom-search-bar"></v-text-field>
              </v-col>
            </v-row>
          </template>
              ...
              <td>
                <v-row class="align-center no-gutters">
                  ...
                  <v-col cols="5">
                    <div>
                      <v-icon class="mr-2">
                        <v-img class="rounded-icon" :src="'data:image/png;base64,' + item.image" height="20"
                          width="20"></v-img>
                      </v-icon>
